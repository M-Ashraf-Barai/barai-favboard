...
if "google" in st.secrets:  # Running on Streamlit Cloud
    creds = Credentials.from_service_account_info(
        st.secrets["google"],
        scopes=["https://www.googleapis.com/auth/spreadsheets"]
    )
    client = gspread.authorize(creds)
    sheet = client.open_by_key(st.secrets["google"]["GOOGLE_SHEET_ID"])
    worksheet = sheet.worksheet(st.secrets["google"]["GOOGLE_SHEET_WORKSHEET_NAME"])
